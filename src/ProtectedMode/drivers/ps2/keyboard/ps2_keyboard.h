...
STATIC_ASSERT(sizeof(kcb_led_state_t) == 1, "kcb_led_sate_t must be of size: 1 byte");
...
STATIC_ASSERT(sizeof(kcb_typematic_rate_and_delay_t) == 1, "kcb_typematic_rate_and_delay_t must be of size: 1 byte");
