...
constexpr uint64_t TEXT_END	  = 0xffffffff80001000;
constexpr uint64_t TEXT_SIZE  = TEXT_END - TEXT_START;

/* Text guard page */
constexpr uint64_t TEXT_GUARD_START = 0xffffffff80001000;
constexpr uint64_t TEXT_GUARD_END	= 0xffffffff80001000;
constexpr uint64_t TEXT_GUARD_SIZE	= TEXT_GUARD_END - TEXT_GUARD_START;

/* Read-only data section */
constexpr uint64_t RODATA_START = 0xffffffff80001000;
constexpr uint64_t RODATA_END	= 0xffffffff80002000;
