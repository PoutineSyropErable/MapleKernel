...
constexpr uint64_t MODULE_SIZE = 0x0000000000419000;
...
/* Module end */
constexpr uint64_t MODULE_END = 0xffffffff80419000;
...
constexpr uint64_t BSS_END	 = 0xffffffff80404010;
...
/* Heap guard page */
constexpr uint64_t HEAP_GUARD_START = 0xffffffff80419000;
constexpr uint64_t HEAP_GUARD_END	= 0xffffffff80419000;
