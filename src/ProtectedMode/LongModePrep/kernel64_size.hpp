...
/* Text guard page */
constexpr uint64_t TEXT_GUARD_START = 0;
constexpr uint64_t TEXT_GUARD_END	= 0;
...
/* Stack guard page */
constexpr uint64_t STACK_GUARD_START = 0;
constexpr uint64_t STACK_GUARD_END	 = 0;
...
/* Heap guard page */
constexpr uint64_t HEAP_GUARD_START = 0;
constexpr uint64_t HEAP_GUARD_END	= 0;
