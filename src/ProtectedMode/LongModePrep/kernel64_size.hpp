...
constexpr uint64_t MODULE_SIZE = 0x0000000000019000;
...
constexpr uint64_t KERNEL64_MAIN_ADDR = 0xffffffff80003360;

/* Module end */
constexpr uint64_t MODULE_END = 0xffffffff80019000;

/* Text section */
constexpr uint64_t TEXT_START = 0xffffffff80001000;
constexpr uint64_t TEXT_END	  = 0xffffffff80002000;
constexpr uint64_t TEXT_SIZE  = TEXT_END - TEXT_START;

/* Text guard page */
constexpr uint64_t TEXT_GUARD_START = 0xffffffff80002000;
constexpr uint64_t TEXT_GUARD_END	= 0xffffffff80002000;
constexpr uint64_t TEXT_GUARD_SIZE	= TEXT_GUARD_END - TEXT_GUARD_START;

/* Read-only data section */
constexpr uint64_t RODATA_START = 0xffffffff80002000;
constexpr uint64_t RODATA_END	= 0xffffffff80003000;
constexpr uint64_t RODATA_SIZE	= RODATA_END - RODATA_START;

/* Rodata guard page */
constexpr uint64_t RODATA_GUARD_START = 0xffffffff80004000;
constexpr uint64_t RODATA_GUARD_END	  = 0xffffffff80004000;
constexpr uint64_t RODATA_GUARD_SIZE  = RODATA_GUARD_END - RODATA_GUARD_START;

/* Data section */
constexpr uint64_t DATA_START = 0xffffffff80004000;
constexpr uint64_t DATA_END	  = 0xffffffff80004000;
constexpr uint64_t DATA_SIZE  = DATA_END - DATA_START;

/* Data guard page */
constexpr uint64_t DATA_GUARD_START = 0xffffffff80004000;
constexpr uint64_t DATA_GUARD_END	= 0xffffffff80004000;
constexpr uint64_t DATA_GUARD_SIZE	= DATA_GUARD_END - DATA_GUARD_START;

/* BSS section */
constexpr uint64_t BSS_START = 0xffffffff80004000;
constexpr uint64_t BSS_END	 = 0xffffffff80004010;
constexpr uint64_t BSS_SIZE	 = BSS_END - BSS_START;

/* BSS guard page */
constexpr uint64_t BSS_GUARD_START = 0xffffffff80005000;
constexpr uint64_t BSS_GUARD_END   = 0xffffffff80005000;
constexpr uint64_t BSS_GUARD_SIZE  = BSS_GUARD_END - BSS_GUARD_START;

/* Stack section */
constexpr uint64_t STACK_BOTTOM = 0xffffffff80005000;
constexpr uint64_t STACK_TOP	= 0xffffffff80009000;
constexpr uint64_t STACK_SIZE	= STACK_TOP - STACK_BOTTOM;

/* Stack guard page */
constexpr uint64_t STACK_GUARD_START = 0xffffffff80009000;
constexpr uint64_t STACK_GUARD_END	 = 0xffffffff80009000;
constexpr uint64_t STACK_GUARD_SIZE	 = STACK_GUARD_END - STACK_GUARD_START;

/* Heap section */
constexpr uint64_t HEAP_START = 0xffffffff80009000;
constexpr uint64_t HEAP_END	  = 0xffffffff80019000;
constexpr uint64_t HEAP_SIZE  = HEAP_END - HEAP_START;

/* Heap guard page */
constexpr uint64_t HEAP_GUARD_START = 0xffffffff80019000;
constexpr uint64_t HEAP_GUARD_END	= 0xffffffff80019000;
