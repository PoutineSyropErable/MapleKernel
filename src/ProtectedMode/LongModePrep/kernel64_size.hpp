...
constexpr uint64_t KERNEL64_MAIN_ADDR = 0xffffffff80001160;
...
constexpr uint64_t TEXT_END	  = 0xffffffff80001187;
...
constexpr uint64_t RODATA_END	= 0xffffffff8000301f;
