...
pub extern fn kprintf_argc(argc: u32, fmt: [*c]const u8, ...) void;
pub extern fn kprintf2_argc_check(argc: u32, fmt: [*c]const u8, ...) void;
pub extern fn vkprintf(fmt: [*c]const u8, args: va_list) void;
pub extern fn kprintf2(fmt: [*c]const u8, ...) void;
pub const FMT_OPTION_NONE: c_int = 0;
pub const FMT_OPTION_NOT_IMPLEMENTED: c_int = 1;
pub const FMT_OPTION_COULD_NOT_CONVERT: c_int = 2;
pub const FMT_OPTION_PAD: c_int = 58;
pub const FMT_OPTION_PRECISION: c_int = 46;
pub const enum_PRINTF_FMT_OPTION = c_uint;
pub const PRINTF_TAG_INVALID: c_int = 0;
pub const PRINTF_TAG_CHAR: c_int = 99;
pub const PRINTF_TAG_STRING: c_int = 115;
pub const PRINTF_TAG_INT: c_int = 100;
pub const PRINTF_TAG_UINT32_T: c_int = 117;
pub const PRINTF_TAG_FLOAT: c_int = 102;
pub const PRINTF_TAG_HEX: c_int = 104;
pub const PRINTF_TAG_BINARY: c_int = 98;
pub const enum_PRINTF_TYPE = c_uint;
pub const struct_PRINTF_FIELD_PROPERTIES = extern struct {
    type: enum_PRINTF_TYPE = @import("std").mem.zeroes(enum_PRINTF_TYPE),
    option: enum_PRINTF_FMT_OPTION = @import("std").mem.zeroes(enum_PRINTF_FMT_OPTION),
    option_num: u8 = @import("std").mem.zeroes(u8),
    len: u8 = @import("std").mem.zeroes(u8),
    pos: u16 = @import("std").mem.zeroes(u16),
};
pub extern fn terminal_writestring(str: [*c]const u8) void;
pub extern fn test_printf() void;
pub extern fn test_assert() void;
...
pub const PP_NARG = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /home/francois/Documents/zzz__PersonalProjects/MapleKernel/src/z_otherLang/zig/../../stdlib/ppnargs.h:3:9
pub const PP_NARG___ = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /home/francois/Documents/zzz__PersonalProjects/MapleKernel/src/z_otherLang/zig/../../stdlib/ppnargs.h:5:9
pub const PP_ARG_N = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /home/francois/Documents/zzz__PersonalProjects/MapleKernel/src/z_otherLang/zig/../../stdlib/ppnargs.h:6:9
pub inline fn PP_RSEQ_N() @TypeOf(@as(c_int, 0)) {
    return blk: {
        _ = @as(c_int, 50);
        _ = @as(c_int, 49);
        _ = @as(c_int, 48);
...
pub const CHECK_ARGC = "";
pub const kprintf = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /home/francois/Documents/zzz__PersonalProjects/MapleKernel/src/z_otherLang/zig/../../stdio/stdio.h:27:9
pub const PRINTF_FMT_OPTION = enum_PRINTF_FMT_OPTION;
pub const PRINTF_TYPE = enum_PRINTF_TYPE;
pub const PRINTF_FIELD_PROPERTIES = struct_PRINTF_FIELD_PROPERTIES;
