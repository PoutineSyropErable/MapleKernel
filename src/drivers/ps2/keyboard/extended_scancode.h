...
#undef EXT_ENUM_ENTRY
    ...
    static const char *extended_scancode_to_string(extended_scancode_t scancode)
    {
        switch (scancode)
        {
#define EXT_STRING_CASE(name, code)                                                                                                        \
    case SCE_##name: return #name;
...
#undef EXT_STRING_CASE
    ...
    static bool validate_extended_scancode(extended_scancode_t scancode)
    {
        switch (scancode)
        {
