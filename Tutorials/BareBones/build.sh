...
nasm -f elf call_realmode_function_wrapper16.s -o "$BUILD_DIR/add16_wrapper16.o"
nasm -f elf32 call_realmode_function_wrapper32.s -o "$BUILD_DIR/add16_wrapper32.o"
