...
CFLAGS=("-std=gnu23" "-ffreestanding" "-O2" "-Wall" "-Wextra" "-g")
CFLAGS16=("-std=gnu99" "-ffreestanding" "-O2" "-Wall" "-Wextra" "-g")
LDFLAGS=("-ffreestanding" "-O2" "-nostdlib" "-lgcc" "-g")
NASM_FLAGS32=("-f" "elf32" "-g" "-F" "dwarf")
NASM_FLAGS16=("-f" "elf" "-g" "-F" "dwarf")
